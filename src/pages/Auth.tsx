...
import { SigninInputs } from "@/models/index";
import { SignupInputs } from "@/models/index";
        ...
        <TabsContent value="signin">
          <Card>
            <form onSubmit={signinHandleSubmit(onSubmitSignin)}>
              ...
              <CardDescription
                className={`errorMsg ${
                  isError ? "text-red-500" : "text-black-500"
                }`}
              >
                {signinErrorMsg}
              </CardDescription>
              <CardContent className="space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <CardDescription>Please enter your password</CardDescription>
                  <Input
                    type="password"
                    id="password"
